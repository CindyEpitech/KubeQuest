...
#    - kubeadm init on kube-1 + Flannel CNI
...
# ═════════════════════════════════════════════════════════════════════════════
#  STEP 2 — kubeadm init on kube-1 + Flannel
# ═════════════════════════════════════════════════════════════════════════════
step "[init] Initializing control plane on kube-1 + installing Flannel..."
ssh_node "${PUB[kube-1]}" "${PRIV[kube-1]}" "POD_CIDR=$POD_CIDR FLANNEL_URL=$FLANNEL_URL bash -s" <<'INIT'
set -euo pipefail
...
INIT
ok "Control plane up, Flannel applied"
